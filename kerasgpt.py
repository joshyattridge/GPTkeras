...
4. Only return the Python function definition for create_model; do not include explanations or markdown fences.
5. Use padding='same' (or otherwise ensure spatial dimensions stay valid) so pooling layers never encounter invalid dimensions for the provided input shape.
6. Start the model with tf.keras.Input(shape=input_shape) and do not pass input_shape directly to other layers.
"""
        return prompt.strip()
